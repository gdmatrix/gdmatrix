          ...
          <h:panelGrid columns="1" summary="" styleClass="rightMenuPanel"
            ...
            <sf:navigationMenu id="rmenu"
             ...
             <h:panelGrid columns="4" width="100%" cellpadding="0" cellspacing="0"
               ...
               <h:graphicImage value="/templates/online/images/round_nw.gif" alt="" />
               <h:panelGroup />
               <h:panelGroup />
               <h:graphicImage value="/templates/online/images/round_ne.gif" alt="" />
               ...
               <h:graphicImage value="/templates/online/images/round_sw.gif" alt="" />
               <h:panelGroup />
               <h:panelGroup />
               <h:graphicImage value="/templates/online/images/round_se.gif" alt="" />
             </h:panelGrid>
            </sf:navigationMenu>
          </h:panelGrid>
        </h:panelGrid>
