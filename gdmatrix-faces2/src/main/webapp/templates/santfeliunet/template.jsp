  ...
  <h:panelGrid columns="1" id="mainLayout" width="100%"
    ...
    styleClass="topSection" columnClasses="column1,column2">
      <h:graphicImage url="/documents/#{userSessionBean.selectedMenuItem.properties['topSection.logo.docid']}" 
                      width="#{userSessionBean.selectedMenuItem.properties['topSection.logo.width']}%" alt=""/>
      <h:graphicImage url="/documents/#{userSessionBean.selectedMenuItem.properties['topSection.banner.docid']}" 
                      width="#{userSessionBean.selectedMenuItem.properties['topSection.banner.width']}%" alt="" />      
    </h:panelGrid>
            ...
            <h:column>
              <h:panelGrid columns="1" id="answerTextGrid">
                <h:panelGrid columns="2" id="answerBar" cellspacing="0" cellpadding="0">
                  <h:graphicImage url="/common/survey/images/#{surveyBean.barImage}" width="#{row.answerPixels}" height="#{surveyBean.barHeight}" id="surveyColor1" alt="" />
                  <h:graphicImage url="/common/survey/images/#{surveyBean.remainImage}" width="#{row.remainPixels}" height="#{surveyBean.barHeight}" id="surveyColor2" alt="" />                  
                </h:panelGrid>                
