  ...
  implements NamingContainer
{
  ...
  public Integer getExpandDepth()
  {
    ...
    ValueExpression ve = getValueExpression("expandDepth");
  ...
  public Integer getHeadingsBaseLevel()
  {
    ...
    ValueExpression ve = getValueExpression("headingsBaseLevel");
    return ve != null ? (Integer)ve.getValue(getFacesContext().getELContext()) : 3;
  }
  ...
  public Boolean getExpandSelected()
  {
    ...
    ValueExpression ve = getValueExpression("expandSelected");
  ...
  public Boolean getHeadingsRender()
  {
    ...
    ValueExpression ve = getValueExpression("headingsRender");
  ...
  {
    ValueExpression ve = getValueExpression("expandedMenuItems");
    if (ve == null) return _expandedMenuItems;
    Set set = (Set)ve.getValue(getFacesContext().getELContext());
    if (set != null) return set;
    ve.setValue(getFacesContext().getELContext(), _expandedMenuItems);
  ...
  public String getMenuStyleClass()
  {
    ...
    ValueExpression ve = getValueExpression("menuStyleClass");
    return ve != null ? (String)ve.getValue(getFacesContext().getELContext()) : null;
  }
  ...
  public String getHeadingsStyleClass()
  {
    ...
    ValueExpression ve = getValueExpression("headingsStyleClass");
    return ve != null ? (String)ve.getValue(getFacesContext().getELContext()) : null;
  }
  ...
  public String getCollapseImageUrl()
  {
    ...
    ValueExpression ve = getValueExpression("collapseImageUrl");
    return ve != null ? (String)ve.getValue(getFacesContext().getELContext()) : null;
  }
