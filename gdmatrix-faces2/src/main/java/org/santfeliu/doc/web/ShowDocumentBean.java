 ...
 */
@CMSManagedBean
public class ShowDocumentBean extends WebBean implements Serializable
{
  @CMSProperty
  ...
  @Deprecated
  private static final String DOCCOD_PROPERTY = "doccod";
  ...
  {
//    if (tempUrl == null) // first time in request
    ...
    throws Exception
  {
    ...
    result = client.loadDocument(docId, 0, ContentInfo.ALL);
  ...
  {    
    ...
    if (docId == null)
    {
      docId = mic.getBrowserSensitiveProperty(DOCCOD_PROPERTY, !directProperty);
    }
    return docId;
  }
