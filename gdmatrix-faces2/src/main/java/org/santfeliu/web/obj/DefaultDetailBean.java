 ...
 * @param <T>
 */
public abstract class DefaultDetailBean<T> extends PageBean implements Savable,
  DetailBean
{
  ...
  public DefaultDetailBean(String outcome)
  {
  ...
  public abstract T load(String objectId) throws Exception;
