...
{
  private static DBRepository repository = new DBRepository();
  private static final Logger log = Logger.getLogger("SQLNode");  
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      while (tokenizer.hasMoreTokens())
      {
        ...
        {
          log.log(Level.SEVERE, "Query failed: [{0}] with {1}, error: {2}",
    ...
    WorkflowInstance instance, String statement) throws Exception
  {
    ...
    log.log(Level.INFO, "Query executed: [{0}] with {1}, rows selected: {2}",
    ...
    WorkflowInstance instance, String statement) throws Exception
  {
    ...
    log.log(Level.INFO, "Query executed: [{0}] with {1}, rows updated: {2}",
