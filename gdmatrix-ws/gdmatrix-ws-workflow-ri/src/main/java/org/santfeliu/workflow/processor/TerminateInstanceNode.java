  ...
  implements NodeProcessor
{
    ...
    throws Exception
  {
    ...
    {
      String message = Template.create(terminationMessage).merge(instance);
      instance.put(WorkflowConstants.TERMINATION_MESSAGE, message);
    }
    if (terminationIcon != null)
    {
      String url = Template.create(terminationIcon).merge(instance);
      instance.put(WorkflowConstants.TERMINATION_ICON, url);
    }
