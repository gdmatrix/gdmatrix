 ...
 * @author realor
 */
public class ScriptReportParameters
{
  private ArrayList<ParameterDefinition> parameterDefinitions =
    new ArrayList<ParameterDefinition>();

  public void addParameter(String name, String description, String type,
     boolean forPrompting)
  {
    ParameterDefinition parameterDefinition = new ParameterDefinition();
    parameterDefinition.setName(name);
    parameterDefinition.setDescription(description);
    parameterDefinition.setForPrompting(forPrompting);
    if (type != null)
    {
      parameterDefinition.setType(ParameterType.fromValue(type));
    }
