...
public class DBEnumTypeItem extends EnumTypeItem
{
  ...
  public DBEnumTypeItem(EnumTypeItem enumTypeItem)
  {
  ...
  public void setEnumType(DBEnumType enumType)
  {
  ...
  {
    setEnumTypeItemId(enumTypeItem.getEnumTypeItemId());
    setEnumTypeId(enumTypeItem.getEnumTypeId());
    setValue(enumTypeItem.getValue());
