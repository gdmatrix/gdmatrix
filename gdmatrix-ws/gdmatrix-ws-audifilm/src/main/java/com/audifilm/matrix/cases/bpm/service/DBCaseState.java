...
public class DBCaseState extends DBGenesysEntity
{
  ...
  private List<DBCaseStateResponsible> responsibles;
  ...
  public List<DBCaseStateResponsible> getResponsibles()
  {
    return responsibles;
  }

  public void setResponsibles(List<DBCaseStateResponsible> responsibles)
  {
  ...
  {
    return new String[] {caseId, estatNum};
  }
