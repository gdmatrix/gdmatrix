 ...
 * @author lopezrj-sf
 */
public class FindPersonsFromEventsQueryBuilder extends QueryBuilder
{
  ...
  public List<DBAttendant> getResultList(EntityManager entityManager)
    throws Exception
  {
  ...
  {
    selectBuffer.append("SELECT a");
    fromBuffer.append("FROM DBAttendant a");
  }

  private void appendEventIdFilter(StringBuilder whereBuffer)
  {
    whereBuffer.append("WHERE ");
    appendInOperator(whereBuffer, "a.eventId", ":", "eventId", eventIdList);
  }
}
