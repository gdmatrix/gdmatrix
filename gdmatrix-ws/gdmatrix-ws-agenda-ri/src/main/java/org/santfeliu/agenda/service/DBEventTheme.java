 ...
 * @author blanquepa
 */
class DBEventTheme extends EventTheme
{
  ...
  public DBEventTheme(EventTheme eventTheme)
  {
    copyFrom(eventTheme);
  }

  public void copyTo(EventTheme eventTheme)
  {
    JPAUtils.copy(this, eventTheme);
  }
  
  public void copyFrom(EventTheme eventTheme)
  {
    JPAUtils.copy(eventTheme, this);
  }
