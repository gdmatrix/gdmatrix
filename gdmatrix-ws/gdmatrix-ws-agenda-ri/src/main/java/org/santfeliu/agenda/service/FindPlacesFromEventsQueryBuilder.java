 ...
 * @author lopezrj-sf
 */
public class FindPlacesFromEventsQueryBuilder extends QueryBuilder
{
  ...
  public List<DBEventPlace> getResultList(EntityManager entityManager)
    throws Exception
  {
  ...
  {
    selectBuffer.append("SELECT ep");
    fromBuffer.append("FROM DBEventPlace ep JOIN FETCH ep.dbEvent");
  }

  private void appendEventIdFilter(StringBuilder whereBuffer)
  {
    whereBuffer.append("WHERE ");
    appendInOperator(whereBuffer, "ep.eventId", ":", "eventId", eventIdList);
  }
}
