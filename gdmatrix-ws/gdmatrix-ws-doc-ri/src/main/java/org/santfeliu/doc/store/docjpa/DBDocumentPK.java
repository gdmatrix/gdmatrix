...
public class DBDocumentPK
{
  ...
  public DBDocumentPK(String docId, int version)
  {
    this.docId = docId;
  ...
  public boolean equals(Object obj)
  {
    ...
    final DBDocumentPK other = (DBDocumentPK) obj;
  ...
  {
    return this.docId + ";" + String.valueOf(version);
  }
}
