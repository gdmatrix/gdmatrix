...
{
  private TreeMap<ResolverType, Resolver> resolvers;
  
  private SignatureResolvers()
  {
    resolvers = new TreeMap<ResolverType, Resolver>();
  }
  
  public Resolver get(ResolverType type)
  {
  ...
  private void put(ResolverType type, Resolver resolver)
  {
    resolvers.put(type, resolver);
  }
  
  public static SignatureResolvers createInstance()
  {
    SignatureResolvers resolvers = new SignatureResolvers();
