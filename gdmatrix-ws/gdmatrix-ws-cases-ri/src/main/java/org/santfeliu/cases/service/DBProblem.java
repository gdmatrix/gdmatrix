 ...
 * @author unknown
 */
public class DBProblem extends Problem
{
  ...
  public DBProblem(Problem problem)
  {
    JPAUtils.copy(problem, this);
  }
  
  public void copyTo(Problem problem)
  {
    JPAUtils.copy(this, problem);
  }
