...
public class DBCasePerson extends CasePerson implements Auditable
{
  ...
  public void copyTo(CasePerson casePerson)
  {
    ...
    casePerson.setCreationUserId(creationUserId);
    casePerson.setCreationDateTime(creationDateTime);
    casePerson.setChangeUserId(changeUserId);
    casePerson.setChangeDateTime(changeDateTime);
  }
