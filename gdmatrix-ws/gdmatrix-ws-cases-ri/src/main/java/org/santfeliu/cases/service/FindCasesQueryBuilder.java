 ...
 * @author blanquepa
 */
public abstract class FindCasesQueryBuilder extends QueryBuilder
{
  protected CaseFilter filter;
  protected List<String> roles;
  protected boolean counterQuery;

  public static FindCasesQueryBuilder getInstance()
  {
    FindCasesQueryBuilder queryBuilder =
      (FindCasesQueryBuilder)QueryBuilder.getInstance(CaseManager.class, "findCases");
    if (queryBuilder == null)
      queryBuilder = new JPAFindCasesQueryBuilder();
