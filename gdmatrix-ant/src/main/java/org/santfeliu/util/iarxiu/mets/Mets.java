...
public class Mets
{
  Map<String, Metadata> dmdMetadatas = new HashMap<String, Metadata>();
  Map<String, Metadata> amdMetadatas = new HashMap<String, Metadata>();
  Map<String, FileGrp> fileGrps = new HashMap<String, FileGrp>();
  Div struct = new Div();

  Map<String, XSDInfo> regSchemas = new HashMap<String, XSDInfo>();
