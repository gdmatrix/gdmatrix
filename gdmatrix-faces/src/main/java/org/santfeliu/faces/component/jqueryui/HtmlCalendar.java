...
public class HtmlCalendar extends org.santfeliu.faces.component.HtmlCalendar
{
  ...
  public boolean isSingleInput()
  {
    ...
    ValueBinding vb = getValueBinding("singleInput");
  ...
  public String getDayLabel()
  {
    ...
    ValueBinding vb = getValueBinding("dayLabel");
  ...
  public String getHourLabel()
  {
    ...
    ValueBinding vb = getValueBinding("hourLabel");
    return vb != null ? (String)vb.getValue(getFacesContext()) : null;
  }
  ...
  public String getTheme()
  {
    ...
    String theme = vb != null ? (String)vb.getValue(getFacesContext()) : null;
