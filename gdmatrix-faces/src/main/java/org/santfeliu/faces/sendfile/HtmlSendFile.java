...
public class HtmlSendFile extends UICommand implements Serializable
{
  ...
  public String getMaxFileSize()
  {
    ...
    ValueBinding vb = getValueBinding("maxFileSize");
    return vb != null ? (String)vb.getValue(getFacesContext()) : null;
  }
  ...
  public String getValidExtensions()
  {
    ...
    ValueBinding vb = getValueBinding("validExtensions");
    return vb != null ? (String)vb.getValue(getFacesContext()) : null;
  }
  ...
  public String getButtonClass()
  {
    ...
    ValueBinding vb = getValueBinding("buttonClass");
    return vb != null ? (String)vb.getValue(getFacesContext()) : null;
  }
  ...
  public Map getFileProperties()
  {
    ...
    ValueBinding vb = getValueBinding("fileProperties");
  ...
  public Map getDocTypes()
  {
    ...
    ValueBinding vb = getValueBinding("docTypes");
    return vb != null ? (Map)vb.getValue(getFacesContext()) : null;
  }
