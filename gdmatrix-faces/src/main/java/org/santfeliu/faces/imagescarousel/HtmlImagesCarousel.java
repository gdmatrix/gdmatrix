...
public class HtmlImagesCarousel extends UIComponentBase
{
  ...
  public String getThumbnailPrevLabel()
  {
    ...
    ValueBinding vb = getValueBinding("thumbnailPrevLabel");
  ...
  public String getThumbnailNextLabel()
  {
    ...
    ValueBinding vb = getValueBinding("thumbnailNextLabel");
    return vb != null ? (String) vb.getValue(getFacesContext()) : 
  ...
  public String getThumbnailPrevIconUrl()
  {
    ...
    ValueBinding vb = getValueBinding("thumbnailPrevIconUrl");
    return vb != null ? (String) vb.getValue(getFacesContext()) : null;
  }
  ...
  public String getThumbnailNextIconUrl()
  {
    ...
    ValueBinding vb = getValueBinding("thumbnailNextIconUrl");
    return vb != null ? (String) vb.getValue(getFacesContext()) : null;
  }
