...
public class HtmlWidgetContainer extends UIPanel
{
  ...
  public List getColumnTitles()
  {
    ...
    ValueBinding vb = getValueBinding("columnTitles");
    if (vb != null)
    {
      Object value = vb.getValue(getFacesContext());
      return (value instanceof List ? (List)value : Arrays.asList(value));
  ...
  public List getColumnRenderAsList()
  {
    ...
    ValueBinding vb = getValueBinding("columnRenderAsList");
    if (vb != null)
    {
      Object value = vb.getValue(getFacesContext());
      return (value instanceof List ? (List)value : Arrays.asList(value));
  ...
  public Boolean getDraggableWidgets()
  {
    ...
    ValueBinding vb = getValueBinding("draggableWidgets");
  ...
  public String getUpdateCallback()
  {
    ...
    ValueBinding vb = getValueBinding("updateCallback");
    return vb != null ? (String)vb.getValue(getFacesContext()) : null;
  }
  ...
  public List getHeaderDocId()
  {
    ...
    ValueBinding vb = getValueBinding("headerDocId");
    if (vb != null)
    {
      Object value = vb.getValue(getFacesContext());
      return (value instanceof List ? (List)value : Arrays.asList(value));
  ...
  public List getFooterDocId()
  {
    ...
    ValueBinding vb = getValueBinding("footerDocId");
    if (vb != null)
    {
      Object value = vb.getValue(getFacesContext());
      return (value instanceof List ? (List)value : Arrays.asList(value));
  ...
  public String getTranslationGroup()
  {
    ...
    return vb != null? (String) vb.getValue(getFacesContext()): "jsp";
  }  
