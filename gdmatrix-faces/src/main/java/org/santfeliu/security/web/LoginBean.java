...
public class LoginBean extends WebBean implements Serializable
{
  ...
  public String getLoginURL()
  {
    ...
    String url = HttpUtils.getServerSecureURL(request,
      FacesServlet.LOGIN_URI, request.getQueryString());
  ...
  public String getLoginCertificateURL()
  {
    ...
    return HttpUtils.getClientSecureURL(request, FacesServlet.GO_URI,
  ...
  public String getCancelURL()
  {
    ...
    String requestQueryString = FacesServlet.XMID_PARAM + "=" + menuItem.getMid();
    return HttpUtils.getServerSecureURL(request, FacesServlet.GO_URI, 
      requestQueryString);
  }
  ...
  public String loginRedirect()
  {
    try
    {
      ...
      if (username != null && username.trim().length() > 0)
      {
        ...
        String url = HttpUtils.getServerSecureURL(request,
          FacesServlet.GO_URI, queryString);
  ...
  public String showLogin()
  {
    ...
    MenuItemCursor menuItem =
      (MenuItemCursor)request.getAttribute(FacesServlet.NEXT_MENU_ITEM_ATTR);
