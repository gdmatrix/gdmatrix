...
public class WidgetBean extends WebBean
{
  ...
  public Integer getCustomColumns()
  {
    ...
    String value = cursor.getProperty(CUSTOM_COLUMNS_PROPERTY);
    return getInteger(value, 3);
  }

  public String getCustomColumnClasses()
  {
    MenuItemCursor cursor = getCursor();
    return cursor.getProperty(CUSTOM_COLUMN_CLASSES_PROPERTY);
  }

  public String getCustomColumnTitles()
  {
    MenuItemCursor cursor = getCursor();
    return cursor.getProperty(CUSTOM_COLUMN_TITLES_PROPERTY);
  }
  
  public String getCustomColumnRenderAsList()
  {
    MenuItemCursor cursor = getCursor();
    return cursor.getProperty(CUSTOM_COLUMN_RENDER_AS_LIST_PROPERTY);
  }
  ...
  public List<WidgetDefinition> getWidgetCatalogue()
  {
    if (widgetCatalogue == null)
    {
      ...
      {
        WidgetLayout layout =
          new WidgetLayout(getCustomColumns(), getCustomLayout());
  ...
  public String apply()
  {
    ...
    // update layout
    int customColumns = getCustomColumns();
    WidgetLayout layout = new WidgetLayout(customColumns, getCustomLayout());
  ...
  private Map<String, HtmlWidgetContainer> prepareContainers()
  {
    ...
    addWidgetIds(containers, Arrays.asList(getCustomLayout()), customContainer);
  ...
  private List<String> getLayoutWidgetIds(boolean includeDynamic)
  {
    ...
    if (includeDynamic) 
    {
      result.addAll(getWidgetIdListFromLayout(Arrays.asList(getCustomLayout())));
    }      
    return result;
  }
