...
public class HtmlDocuments extends UIComponentBase
{
  ...
  public String getDocTypeId()
  {
    ...
    ValueBinding vb = getValueBinding("docTypeId");
  ...
  public Boolean getDirectDownload()
  {
    ...
    ValueBinding vb = getValueBinding("directDownload");
  ...
  public String getDocumentSearchMid()
  {
    ...
    ValueBinding vb = getValueBinding("documentSearchMid");
    return vb != null? (String) vb.getValue(getFacesContext()): null;
  }
  ...
  public void updateModel(FacesContext context)
  {
    if (_docTypeId != null)
    {
      ...
      if (vb != null)
      {
        ...
        {
          vb.setValue(context, _docTypeId);
          _docTypeId = null;
        }
      }
    }
