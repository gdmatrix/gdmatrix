...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
  ...
  <t:div styleClass="editingPanel" rendered="#{!roleRolesBean.new}" style="margin-bottom:15px">
  ...
  <t:div styleClass="collapsiblePanel" style="margin-top:5px"
       rendered="#{!roleRolesBean.new and !empty roleRolesBean.containers}">
