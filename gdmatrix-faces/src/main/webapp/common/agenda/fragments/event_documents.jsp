...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
    ...
    <t:buffer into="#{table}">
      <t:dataTable id="dataDocs" value="#{eventDocumentsBean.rows}" var="row"
        ...
        <t:column style="width:41%" headerstyleClass="header">
          ...
          <h:outputText value="#{row.document.title != null ? row.document.title : agendaBundle.eventDocuments_notAvaliable}" rendered="#{row.document.content == null}" />
        </t:column>
  ...
  <sf:sendfile action="#{eventDocumentsBean.refresh}"
               command="#{eventDocumentsBean.command}"
               result="#{eventDocumentsBean.docId}"
