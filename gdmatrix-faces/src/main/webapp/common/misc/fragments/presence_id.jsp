...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
  ...
  <h:panelGrid columns="2" styleClass="presenceIdPanel" width="100%"
    ...
    <h:panelGroup>
      <t:inputSecret id="idCode" forceId="true" value="#{presenceBean.idCode}"
        style="font-size:50px;width:160px" styleClass="idCode"
        onkeyup="checkCode(this);" />
      <t:commandButton id="sendIdCode" forceId="true"
        action="#{presenceBean.identify}"
