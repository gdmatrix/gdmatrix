...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
  ...
  <script type="text/javascript">
      <![CDATA[
        ...
        document.getElementById('mainform:cmsEditSeparator').style.height = (viewportheight - 80) + 'px';
        document.getElementById('mainform:treeLayer').style.height = (viewportheight - 150) + 'px';
        try
        {
          document.getElementById('mainform:propertiesLayer').style.height = (viewportheight - 120) + 'px';
        }
        catch(err)
        {
        ...
        try
        {
          document.getElementById('mainform:cssTextArea').style.height = (viewportheight - 125) + 'px';
        }
        catch(err)
        {
        ...
        try
        {
          document.getElementById('mainform:syncLayer').style.height = (viewportheight - 120) + 'px';
        }
        catch(err)
        {
        ...
        try
        {
          document.getElementsByClassName('nodeSearchPanel')[0].style.height = (viewportheight - 80) + 'px';
        }
        catch(err)
        {
