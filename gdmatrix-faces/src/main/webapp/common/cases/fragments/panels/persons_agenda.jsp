...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
    ...
    <t:div styleClass="personsAgendaPanel">
      <sf:agenda themes="#{panel.agendaThemes}" eventTypes="#{panel.agendaTypes}"
        personId="#{panel.personId}" nameStyleClass="eventName" rows="#{panel.pageSize}"
        ...
        var="e" />
      <h:outputLink value="go.faces?xmid=#{panel.agendaSearchMid}&amp;personid=#{panel.personId}"
