      ...
      <h:panelGrid columns="2" styleClass="header" 
        ...
        <f:facet name="header">
          <h:outputLink value="#{userSessionBean.selectedMenuItem.properties.pantoneUrl == null ? 
            ...
            <h:graphicImage url="#{userSessionBean.selectedMenuItem.properties.pantone}" width="100%" style="border:none"/>
          </h:outputLink>
        </f:facet>
        ...
        <h:panelGrid columns="1" summary="" styleClass="rightMenuPanel"
          ...
          <sf:navigationMenu id="rmenu"
             ...
             <h:panelGrid columns="4" width="100%" cellpadding="0" cellspacing="0"
               ...
               <h:graphicImage value="/templates/portal/images/round_nw.gif" />
               <h:panelGroup />
               <h:panelGroup />
               <h:graphicImage value="/templates/portal/images/round_ne.gif" />
               ...
               <h:graphicImage value="/templates/portal/images/round_sw.gif" />
               <h:panelGroup />
               <h:panelGroup />
               <h:graphicImage value="/templates/portal/images/round_se.gif" />
             </h:panelGrid>
          </sf:navigationMenu>
        </h:panelGrid>
      </h:panelGrid>
