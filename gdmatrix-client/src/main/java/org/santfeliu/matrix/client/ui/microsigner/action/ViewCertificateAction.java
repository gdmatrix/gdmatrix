...
import org.santfeliu.matrix.client.ui.microsigner.CertificateNode;
  ...
  public void actionPerformed(ActionEvent event)
  {
    ...
    if (certNode != null)
    {
      CertificateInfoDialog dialog = 
        new CertificateInfoDialog(mainPanel.getFrame());
      dialog.setLocationRelativeTo(mainPanel);
      dialog.setCertificate(certNode.getCertificate());
