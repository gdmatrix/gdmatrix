 ...
 * @author realor
 */
public class ReloadKeyStoreAction extends AbstractAction
{
  private final MainPanel mainPanel;
  
  public ReloadKeyStoreAction(MainPanel mainPanel)
  {  
    super.putValue(Action.NAME, 
      MicroSigner.getLocalizedText("ReloadKeyStore"));
  ...
  public void actionPerformed(ActionEvent event)
  {
    try
    {
      ...
      if (ksNode != null)
      {
        MicroSigner.loadKeyStore(ksNode.getProviderClassName(), 
                                 ksNode.getKeyStoreType(),
                                 ksNode.getKeyStorePath(),
                                 ksNode.getKeyStorePassword(),
                                 ksNode);
