...
public class Div
{
  ...
  private List<Metadata> dmdMetadatas = new ArrayList<>();
  private List<Metadata> amdMetadatas = new ArrayList<>();
  ...
  public String toString()
  {
    ...
    sb.append("<div>");
    sb.append(label).append(" ").append(dmdMetadatas)
      .append(",").append(amdMetadatas);
    for (Div div : divs)
    {
      sb.append("\n").append(div);
    }
    if (fileGrp != null)
      sb.append("*").append(fileGrp);
    sb.append("</div>");
    return sb.toString();
  }
