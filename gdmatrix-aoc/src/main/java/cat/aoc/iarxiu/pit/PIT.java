...
import cat.aoc.iarxiu.mets.Mets;
import cat.aoc.iarxiu.mets.MetsLoader;
import cat.aoc.iarxiu.mets.MetsWriter;
import cat.aoc.iarxiu.converter.Converter;
...
public class PIT
{
  ...
  {
    List<PITDocument> result = new ArrayList<>();
    if (!complex)
    {
      Div struct = mets.getStruct();
      for (Div div : struct.getDivs())
