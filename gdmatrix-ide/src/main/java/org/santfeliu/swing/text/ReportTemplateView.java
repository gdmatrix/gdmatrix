 ...
 * @author blanquepa
 */
public class ReportTemplateView extends PlainView
{
  private ReportTemplateEditorKit kit;
  
  public ReportTemplateView(Element elem, ReportTemplateEditorKit kit)
  {
    super(elem);
    this.kit = kit;
  }
