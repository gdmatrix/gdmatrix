 ...
 * @author realor
 */
public class RadioButtonEditor extends JPanel
  implements ComponentEditor
{
  ...
  {
    this.radioButtonView = (RadioButtonView)view;
    variableTextField.setText(radioButtonView.getVariable());
    valueTextField.setText(radioButtonView.getValue());
    return this;
  }
  ...
  public void stopEditing() throws Exception
  {
    ...
    radioButtonView.setVariable(variable);
    radioButtonView.setValue(valueTextField.getText());
  }
