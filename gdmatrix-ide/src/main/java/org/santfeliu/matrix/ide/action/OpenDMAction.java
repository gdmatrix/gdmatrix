...
import org.santfeliu.matrix.ide.DocumentSelectionDialog;
...
public class OpenDMAction extends BaseAction
{
  ...
  public void actionPerformed(ActionEvent event)
  {
    ...
    {      
      ...
      if (connectionParameters != null)
      {
        DocumentSelectionDialog dialog = 
          new DocumentSelectionDialog(getIDE(), mainPanel);
        dialog.showDialog(mainPanel);
        if (dialog.getSelectedDocId() != null)
        {
          ide.getMainPanel().openDocumentFromDM(
            dialog.getSelectedDocumentType(),
            dialog.getSelectedDocId(),
    ...
    {
      JOptionPane.showMessageDialog(mainPanel, ex.toString(),
