  ...
  implements NodeEditor
{
  ...
  private JScrollPane scrollPane2 = new JScrollPane()
  {
    ...
    public Dimension getPreferredSize()
    {
      return new Dimension(10,
        tableModel.getRowCount() * optionsTable.getRowHeight());
    }
  };
  ...
  private void initComponents() throws Exception
  {
    ...
    cssCustomTextArea.setFont(Options.getEditorFont());
    cssCustomTextArea.setLineWrap(true);
    cssCustomTextArea.setWrapStyleWord(true);
    cssCustomTextArea.setRows(3);
    ...
    this.add(messageLabel,
      new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.HORIZONTAL,
        new Insets(2, 4, 2, 4), 0, 0));
    this.add(scrollPane,
      new GridBagConstraints(1, 1, 1, 1, 1.0, 0.3, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
        new Insets(2, 4, 2, 4), 0, 0));
    ...
    this.add(scrollPane2,
      new GridBagConstraints(1, 2, 1, 4, 1.0, 0.4, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
        new Insets(2, 4, 2, 4), 0, 0));
    ...
    this.add(scrollPane3,
      new GridBagConstraints(1, 8, 1, 1, 1.0, 0.3, GridBagConstraints.CENTER, GridBagConstraints.BOTH,
        new Insets(2, 4, 2, 4), 0, 0));

    scrollPane.getViewport().add(messageTextArea);
    scrollPane2.getViewport().add(optionsTable);
