...
public class MonitorFormParametersEditor extends JPanel implements NodeEditor
{
  ...
  private void initComponents() throws Exception
  {
    ...
    Dimension dim = endVarTextField.getPreferredSize();
    dim.width = 5 * dim.height;
    endVarTextField.setPreferredSize(dim);
    endVarTextField.setMinimumSize(dim);
    cancelVarTextField.setPreferredSize(dim);
    cancelVarTextField.setMinimumSize(dim);
    progressVarTextField.setPreferredSize(dim);
    progressVarTextField.setMinimumSize(dim);
    refreshTimeTextField.setPreferredSize(dim);
    refreshTimeTextField.setMinimumSize(dim);
    ...
    this.add(progressVarTextField,
      new GridBagConstraints(1, 3, 1, 1, 0.5, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(4, 0, 4, 0), 0, 0));
    ...
    this.add(refreshTimeTextField,
      new GridBagConstraints(1, 4, 1, 1, 0.5, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
        new Insets(4, 0, 4, 0), 0, 0));
  }
}
