...
public class NodeEditorDialog extends JDialog
{
    ...
    throws Exception
  {
    ...
    Dimension dim = nodeIdTextField.getPreferredSize();
    dim.width = 5 * dim.height;
    nodeIdTextField.setPreferredSize(dim);
    nodeIdTextField.setMinimumSize(dim);
    ...
    northPanel.add(nodeIdTextField,
      new GridBagConstraints(1, 0, 2, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE,
