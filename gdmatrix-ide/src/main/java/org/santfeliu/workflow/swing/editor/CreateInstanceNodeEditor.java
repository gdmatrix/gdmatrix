 ...
 * @author unknown
 */
public class CreateInstanceNodeEditor extends JPanel
  implements NodeEditor
{
    ...
    throws Exception
  {
    ...
    parametersTextArea.setFont(new Font("Courier New", 0, 16));
    ...
    this.wfNameTextField.setDocument(new RestrictedDocument("[a-zA-Z_][a-zA-Z0-9_]*"));
  }
}
