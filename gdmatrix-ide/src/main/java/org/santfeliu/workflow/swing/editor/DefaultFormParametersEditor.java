 ...
 * @author realor
 */
public class DefaultFormParametersEditor extends JPanel implements NodeEditor
{
  ...
  public DefaultFormParametersEditor()
  {
    try
    {
      initComponents();
    ...
    WorkflowNode node)
  {
    ...
    textArea.setText(parameters.saveToString());
    return this;
  }
  ...
  public void stopEditing() throws Exception
  {
    ...
    parameters.loadFromString(textArea.getText());
