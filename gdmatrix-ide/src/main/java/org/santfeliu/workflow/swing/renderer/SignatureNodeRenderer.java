 ...
 * @author unknown
 */
public class SignatureNodeRenderer extends AbstractNodeRenderer
{
  private static final Color background = new Color(255, 230, 230);
  private Border border = BorderFactory.createLineBorder(Color.red, 2);

  public SignatureNodeRenderer()
  {
  }
  ...
  {
    SignatureNode signatureNode = (SignatureNode) node;
    return signatureNode.getOperation();
  }
