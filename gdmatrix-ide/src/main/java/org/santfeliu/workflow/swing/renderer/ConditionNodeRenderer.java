...
import org.santfeliu.swing.border.RoundBorder;
 ...
 * @author realor
 */
public class ConditionNodeRenderer extends AbstractNodeRenderer
{
  private static final Border BORDER = new RoundBorder(Color.blue, 1);

  public ConditionNodeRenderer()
  {
  }
