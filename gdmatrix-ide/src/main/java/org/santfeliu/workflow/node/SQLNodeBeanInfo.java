...
{
  public SQLNodeBeanInfo()
  {
    this(SQLNode.class);
  }
  
  public SQLNodeBeanInfo(Class beanClass)
  {
    super(beanClass);
    addProperty("dsn").setCategory(SPECIFIC_CATEGORY);    
    addProperty("statements").setCategory(SPECIFIC_CATEGORY);
