...
{
  public WaitNodeBeanInfo()
  {
    this(WaitNode.class);
  }

  public WaitNodeBeanInfo(Class beanClass)
  {
    super(beanClass);
    addProperty("dateTime").setCategory(SPECIFIC_CATEGORY);
    addProperty("duration").setCategory(SPECIFIC_CATEGORY);
  }
