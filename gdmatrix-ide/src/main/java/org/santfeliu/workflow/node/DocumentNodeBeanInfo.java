...
{
  public DocumentNodeBeanInfo()
  {
    this(DocumentNode.class);
  }
  
  public DocumentNodeBeanInfo(Class beanClass)
  {
    super(beanClass);
    addProperty("serviceURL").setCategory(SPECIFIC_CATEGORY);    
    addProperty("operation").setCategory(SPECIFIC_CATEGORY);
    addProperty("documentVar").setCategory(SPECIFIC_CATEGORY);
    addProperty("fileVar").setCategory(SPECIFIC_CATEGORY);
    addProperty("reference").setCategory(SPECIFIC_CATEGORY);
    addProperty("filePath").setCategory(SPECIFIC_CATEGORY);
    addProperty("fileURL").setCategory(SPECIFIC_CATEGORY);
