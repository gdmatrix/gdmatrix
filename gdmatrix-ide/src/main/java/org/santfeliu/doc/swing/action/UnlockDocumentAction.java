 ...
 * @author unknown
 */
public class UnlockDocumentAction extends AbstractAction
{
  protected DocumentBasePanel documentPanel;
  
  public UnlockDocumentAction(DocumentBasePanel documentPanel)
  {
    this.documentPanel = documentPanel;
    this.putValue(Action.NAME, documentPanel.getLocalizedText("unlock"));
  }
  ...
  public void actionPerformed(ActionEvent e)
  {
    try
    {
      ...
      documentPanel.getClient().unlockDocument(docId, 
  ...
  {
    return documentPanel.isDocumentLockedByUser() 
