...
public class LockDocumentAction extends AbstractAction
{
  ...
  public LockDocumentAction(DocumentBasePanel documentPanel)
  {
    this.documentPanel = documentPanel;
    this.putValue(Action.NAME, documentPanel.getLocalizedText("lock"));
  }
...
//      documentPanel.isDocumentActive() && documentPanel.existsDocument());
    return (!documentPanel.isDocumentLocked() && documentPanel.existsDocument());
  }
