 ...
 * @author realor
 */
public class Feature extends HashMap<String, Object>
{
  ...
  public Feature(String geometryColumnName)
  {
  ...
  {
    return (String)get(geometryColumnName);
  }

  public void setGeometry(String wkt)
  {
    put(geometryColumnName, wkt);
  }
