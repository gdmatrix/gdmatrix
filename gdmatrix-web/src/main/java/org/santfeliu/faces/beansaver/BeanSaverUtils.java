...
public class BeanSaverUtils
{
  ...
  public static boolean isViewSavingMethod()
  {
  ...
  public static boolean isSessionSavingMethod()
  {
    String savingMethod = 
      MatrixConfig.getProperty(BeanSaverUtils.BEAN_SAVING_METHOD);     
