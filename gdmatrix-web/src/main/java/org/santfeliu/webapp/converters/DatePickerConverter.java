...
public class DatePickerConverter extends DateConverter
{
  ...
  public String getAsObject(FacesContext fc, UIComponent uic, String userDate)
  {
    ...
    String internalDate = getAsObject(fc, userDate, userFormat, internalFormat);
    if (internalDate == null && !USER_DATE_FORMAT.equals(userFormat))
    {
      // try USER_DATE_FORMAT
      internalDate = getAsObject(fc, userDate, USER_DATE_FORMAT, internalFormat);
    }
    return internalDate;
  }
