...
{
  public static Object[] getRow(Object row, List<Column> columns, 
    String rowTypeId) throws Exception
  {
    ...
    for (int i = 0; i < columns.size(); i++)
    {
      ...
      if (property != null)
      {
        ...
        object[i] = formatValue(rowTypeId, columnName, value);            
      }
    } 
    return object;
  }
    
  private static Object formatValue(String rowTypeId, Object key, 
  ...
  private static Object formatEnumType(String enumTypeId, Object value) 
    throws Exception
  {
    Object result = value;
