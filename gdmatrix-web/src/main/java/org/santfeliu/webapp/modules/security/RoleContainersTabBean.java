...
public class RoleContainersTabBean extends TabBean
{
  ...
  {
    return editing == null ? NEW_OBJECT_ID : editing.getContainerRoleId();
  }

  public void setContainerRoleId(String roleId)
  {
    if (editing != null)
    {
      editing.setContainerRoleId(roleId);
    }
  }
  ...
  public void load()
  {
    if (!NEW_OBJECT_ID.equals(getObjectId()))
    {
      try
      {
        ...
        filter.setIncludedRoleId(getObjectId());
  ...
  public void store()
  {
    try
    {
      editing.setIncludedRoleId(getObjectId());
      try
      {
