...
@Named
@ApplicationScoped
public class TranslationModuleBean
{
  public static TranslationManagerPort getPort(String userId, String password)
  {
    WSDirectory wsDirectory = WSDirectory.getInstance();
    WSEndpoint endpoint = wsDirectory.getEndpoint(TranslationManagerService.class);

    return endpoint.getPort(TranslationManagerPort.class, userId, password);
  }

  public static TranslationManagerPort getPort(boolean asAdmin) throws Exception
  {
    String userId;
    String password;
    if (asAdmin)
