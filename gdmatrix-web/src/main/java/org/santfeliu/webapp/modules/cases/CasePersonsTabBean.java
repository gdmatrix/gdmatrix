  ...
  implements DataTableRowExportable
{
  ...
  public class TabInstance
  {
    ...
    RowsFilterHelper rowsFilterHelper = RowsFilterHelper.create(null, prev -> 
      new RowsFilterHelper<CasePersonsDataTableRow>(prev)
    {
      @Override
      ...
      @Override
      public Item getFixedColumnValue(CasePersonsDataTableRow row, 
        String columnName) 
      {
    ...
    RowsFilterHelper rowsFilterHelper2 = 
      RowsFilterHelper.create(rowsFilterHelper, 
        prev -> new RowsFilterHelper<CasePersonsDataTableRow>(prev)
    {
      @Override
      public ObjectBean getObjectBean() 
      {
