...
@Named
@ApplicationScoped
public class PolicyModuleBean
{
  public static PolicyManagerPort getPort(String userId, String password)
  {
    WSDirectory wsDirectory = WSDirectory.getInstance();
    WSEndpoint endpoint = wsDirectory.getEndpoint(PolicyManagerService.class);

    return endpoint.getPort(PolicyManagerPort.class, userId, password);
  }

  public static PolicyManagerPort getPort(boolean asAdmin) throws Exception
  {
    String userId;
    String password;
    if (asAdmin)
