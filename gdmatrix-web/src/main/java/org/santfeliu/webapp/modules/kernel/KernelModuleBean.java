...
@Named
@ApplicationScoped
public class KernelModuleBean
{
  public static KernelManagerPort getPort(String userId, String password)
  {
  ...
  public static KernelManagerPort getPort(boolean asAdmin) throws Exception
  {
    String userId;
    String password;
    if (asAdmin)
