...
@Named
@ApplicationScoped
public class ClassifModuleBean
{
  public static ClassificationManagerPort getPort(String userId, String password)
  {
    WSDirectory wsDirectory = WSDirectory.getInstance();
    WSEndpoint endpoint = wsDirectory.getEndpoint(ClassificationManagerService.class);

    return endpoint.getPort(ClassificationManagerPort.class, userId, password);
  }

  public static ClassificationManagerPort getPort(boolean asAdmin)
    throws Exception
  {
    String userId;
    String password;
