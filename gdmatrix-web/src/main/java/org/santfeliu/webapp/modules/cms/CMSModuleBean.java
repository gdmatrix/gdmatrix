 ...
 */
package org.santfeliu.webapp.modules.cms;
...
@Named
@ApplicationScoped
public class CMSModuleBean
{
  public static CMSManagerPort getPort(String userId, String password)
  {
  ...
  public static CMSManagerPort getPort(boolean asAdmin) throws Exception
  {
    String userId;
    String password;
    if (asAdmin)
