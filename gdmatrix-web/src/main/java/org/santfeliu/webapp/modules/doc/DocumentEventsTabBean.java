...
@Named
@RequestScoped
public class DocumentEventsTabBean extends TabBean
{  
  ...
  public void init()
  {
    groupableRowsHelper = new GroupableRowsHelper()
    {
      ...
      {
        return DocumentEventsTabBean.this.getObjectBean();
      }
      ...
      public String getFixedColumnValue(Object row, String columnName)
      {
        ...
        if ("eventId".equals(columnName))
        {
          return eventDocumentView.getEvent().getEventId();
        }
        else if ("eventSummary".equals(columnName))
        {
          return eventDocumentView.getEvent().getSummary();
        }
  ...
  {
    EditTab tab = documentObjectBean.getActiveEditTab();
  ...
  public void load() throws Exception
  {
    ...
    if (!NEW_OBJECT_ID.equals(getObjectId()))
    {
      try
      {
        ...
        filter.setDocId(documentObjectBean.getObjectId());
  ...
  public void store()
  {
    try
    {
      if (editing != null)
      {
        String docId = documentObjectBean.getObjectId();
