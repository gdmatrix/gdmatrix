...
{
  final static HashMap<String, Operator> binaryCQLOperators = new HashMap<>();
  final static HashMap<String, Operator> unaryCQLOperators = new HashMap<>();
  final static HashMap<String, Operator> binaryNativeOperators = new HashMap<>();
  final static HashMap<String, Operator> unaryNativeOperators = new HashMap<>();
