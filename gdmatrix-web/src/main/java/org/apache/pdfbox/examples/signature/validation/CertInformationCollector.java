 ...
 * https://svn.apache.org/viewvc/pdfbox/trunk/examples/src/main/java/org/apache/pdfbox/examples/signature/validation/CertInformationCollector.java?view=co
 * 
...
public class CertInformationCollector
{
    ...
    public class CertSignatureInformation
    {
        ...
        {
          return "CertSignatureInformation{" + "certificate=" + certificate.getSubjectDN().getName() + ", ocspUrl=" + ocspUrl + ", crlUrl=" + crlUrl + ", certChain=" + certChain + ", tsaCerts=" + tsaCerts + ", alternativeCertChain=" + alternativeCertChain + '}';
        }         
    }
}
