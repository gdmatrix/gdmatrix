...
public class GroupableHelper
{
  ...
  {
    return (groupedRows == null || groupedRows.size() <= 1 || 
      isRenderGroupButtonMode());
  }
  ...
  public int getGroupsPageSize()
  {
    ...
    String pageSize = UserSessionBean.getCurrentInstance().getMenuModel()
      .getSelectedMenuItem().getProperty(GROUPS_PAGE_SIZE_PROPERTY);
    if (pageSize != null)
      return Integer.valueOf(pageSize);
    else
      return pageBacking.getPageSize();
  }
