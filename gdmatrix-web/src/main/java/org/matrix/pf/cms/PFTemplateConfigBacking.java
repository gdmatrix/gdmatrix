...
public class PFTemplateConfigBacking extends WebBacking
{
  ...
  {
    this.configHelper = new CMSConfigHelper();
  }
  
  public String getIcon()
  {
    return getDirectProperty(ICON);
  }
  
  public void setIcon(String icon)
  {
    configHelper.setProperty(ICON, icon);
  } 
  
  public String getLMenu()
  {
    return getDirectProperty(LMENU);
  }
  
  public void setLMenu(String lmenu)
  {
    configHelper.setProperty(LMENU, lmenu);
  }  
  ...
  public void store()
  {
    ...
    {
      error(ex);
      Logger.getLogger(PFTemplateConfigBacking.class.getName()).
