	...
	CKEDITOR.plugins.add( 'iframe', {
		...
		afterInit: function( editor ) {
			...
			if ( dataFilter ) {
              ...
              if (element.attributes.width == null && element.styles.width != null)
                element.attributes.width = element.styles.width;
              if (element.attributes.height == null && element.styles.height != null)
                element.attributes.height = element.styles.height;                                                        
