...
{
  /**
   * StringTranslator translates a String from default language to another
   * language. StringTranslator instances are thread safe.
   * 
   * @param text: text to be translated
   * @param language: translation language 
   * @param group: translation group
   * @return the translation of text to language or null
