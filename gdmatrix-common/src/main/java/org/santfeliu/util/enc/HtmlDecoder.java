...
public class HtmlDecoder
{
  ...
  public static String decode(String s)
  {
    ...
    while (curPos < maxPos)
    {
      ...
      char[] cArray = null; //surrogate pair
      if (c == '&')
      {
        tmpPos = curPos;
        if (tmpPos < maxPos)
      ...
      if (cArray != null)
      {
        for (char cAux : cArray) sb.append(cAux);
      }
      else
      {
        sb.append(c);
  ...
  {
    System.out.println(HtmlDecoder.decode("Esto &eacute;s una canci&oacute;n."));
  }
}
